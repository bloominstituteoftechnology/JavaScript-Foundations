...
let numerator = Math.abs (principal*n1*monthlyInterestRate);
...
function mortgageCalculator (name, principal, interestRate, years) {
    ...
    numerator = Math.abs(principal*n1*monthlyInterestRate);
    denominator = (n1-1);
...
*/
// mortgageCalculator("Nicole", 200000, 0.05, 30);
...
mortgageCalculator ("Nicole" ,200000, 0.05, 30, 670)
...
*/
let variableInterestRate = function (name, principal, interestRate, years) {
...
variableInterestRate ("Nicole", 200000, 0.05, 30)
